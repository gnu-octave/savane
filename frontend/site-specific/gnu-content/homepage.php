...
<p>'._('Savannah aims to be a central point for development, maintenance and
distribution of <a href="//www.gnu.org/software/">official GNU
software</a>.  In addition, for projects that support free software but
are not part of GNU, we provide <a
href="//savannah.nongnu.org/">savannah.nongnu.org</a>.').'</p>
