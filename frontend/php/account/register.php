...

{
  ...
  print '<p><span class="preinput">'._("Password: (minimum $MIN_PASSWD_LENGTH characters, must contain symbols, digits (0-9) and upper and lower case letters - at least two of each)").'</span><br />&nbsp;&nbsp;';
