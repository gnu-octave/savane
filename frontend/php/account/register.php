...

{
  ...
  print '<p><span class="preinput">'._("Password / passphrase:")." "._("(not too short, must contain multiple character classes: symbols, digits (0-9), upper and lower case letters)").'</span><br />&nbsp;&nbsp;';
